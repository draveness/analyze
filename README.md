...
| Redis | 3.2.5  | [Redis 和 I/O 多路复用](https://github.com/Draveness/iOS-Source-Code-Analyze/blob/master/contents/Redis/redis-io-multiplexing.md) <br> [Redis 中的事件循环](https://github.com/Draveness/iOS-Source-Code-Analyze/blob/master/contents/Redis/redis-eventloop.md) |
